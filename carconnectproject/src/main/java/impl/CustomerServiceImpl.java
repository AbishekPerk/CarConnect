...
public class CustomerServiceImpl implements CustomerService{
	...
	public Customer getCustomerById(int customerId) {
		...
		try {
			...
			if(rs.next()) {
				c = new Customer(rs.getInt("customerID"),rs.getString("FirstName"),rs.getString("LastName"),rs.getString("Email"),rs.getString("PhoneNo"),rs.getString("Address"),rs.getString("Username"),rs.getString("Password"),rs.getString("RegistrationDate"));
			}else {
	...
	public String updateCustomer(Customer customerData,int customerId) {
		...
		String rs;
		try {
			pstmt=con.prepareStatement("update customer set FirstName=?,LastName=?,Email=?,PhoneNo=?,Address=?,Username=?,Password=?,RegistrationDate=? where customerID=?");
