...
public class VehicleServiceImpl implements VehicleService {
	...
	public Vehicle getVehicleById(int vehicleId) {
		...
		try {
			...
			if(rs.next()) {
				vh = new Vehicle(rs.getInt("VehicleID"),rs.getString("Model"),rs.getString("Make"),rs.getInt("Year"),rs.getString("Color"),rs.getString("RegistrationNo"),rs.getInt("Availability"),rs.getDouble("DailyRate"));
			}else {
				try {
	...
	public String updateVehicle(Vehicle vehicleData,int vehicleId) {
		...
		String rs;
		try {
			pstmt=con.prepareStatement("update vehicle set Model=?,Make=?,Year=?,Color=?,RegistrationNo=?,Availability=?,DailyRate=? where VehicleID=?");
