...
public class AdminServiceImpl implements AdminService {
	...
	public Admin getAdminById(int adminId) {
		...
		try {
			...
			if(rs.next()) {
				ad = new Admin(rs.getInt("AdminID"),rs.getString("FirstName"),rs.getString("Lastname"),rs.getString("Email"),rs.getString("PhoneNo"),rs.getString("Username"),rs.getString("Password"),rs.getString("Role"),rs.getString("JoinDate"));
			}else {
	...
	public String updateAdmin(Admin adminData,int adminId) {
		...
		String rs;
		try {
			pstmt=con.prepareStatement("update admin set FirstName=?,Lastname=?,Email=?,PhoneNo=?,Username=?,Password=?,Role=?,JoinDate=? where AdminID=?");
